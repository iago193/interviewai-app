...
export function Login() {
  const inputStyle =
    "bg-gray-500/50 transition mt-4 duration-300 rounded-lg p-2 w-full outline-0 focus:outline-2 transform focus:scale-102 outline-blue-300 focus:shadow-blue-400 shadow-sm";
  return (
    <section className="w-full h-screen">
      <div className="flex justify-center items-center w-full h-full">
        <div
          className="text-white bg-blue-700/50 backdrop-blur-2xl
                w-96 rounded-2xl p-4"
        >
          <h2 className="border-b-2 border-b-gray-500 pb-2 text-2xl">Login!</h2>
          ...
          <div className="mt-6">
            <h2 className="block text-sm text-center">Entre também com</h2>
          ...
          <div className="w-full text-center mt-6 border-t-2 border-t-gray-500 py-4">
